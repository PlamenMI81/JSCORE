$(() => {
  const app = Sammy('#container', function () {
    ...
    this.post('#/register', (ctx) => {
      ...
      let repeatPass = ctx.params.check
    ...
    this.get('#/receipts', (ctx) => {
      ...
      receipt.getAllActReceipt(sessionStorage.getItem('userId'))
        .then((receipts) => {
    ...
    //
    //   ctx.loadPartials({
    //     header: './templates/common/menu.hbs',
    //     footer: './templates/common/footer.hbs',
    ...
    this.get('#/overview', (ctx) => {
      ...
      receipt.getMyReceipt(sessionStorage.getItem('userId'))
        .then((receipt) => {
          ctx.receipts = receipt
          ctx.user = sessionStorage.getItem('username')
          ctx.loadPartials({
            menu: './templates/common/menu.hbs',
            footer: './templates/common/footer.hbs',
            row: './templates/receipt/row.hbs'
          }).then(function () {
